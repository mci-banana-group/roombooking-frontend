...
class BookingDetailsCardState extends State<BookingDetailsCard> with SingleTickerProviderStateMixin {
      ...
      if (mounted) {
        setState(() {
          ...
          _equipment = Map.fromEntries(
            _equipment.entries.toList()..sort((a, b) => a.key.displayName.compareTo(b.key.displayName)),
          );
  ...
  List<String> _getSelectedEquipment() {
    return _equipment.entries.where((entry) => entry.value).map((entry) => entry.key.apiValue).toList();
  }
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.search, color: primaryColor, size: 20, semanticLabel: 'Search'),
                  ...
                  children: [
                    ...
                    _isLoadingBuildings
                        ...
                        ? Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.error_outline, color: Colors.red, size: 18, semanticLabel: 'Error'),
                                    const SizedBox(width: 8),
                                    Expanded(
                                      child: Text(_buildingsError!, style: TextStyle(color: Colors.red, fontSize: 12)),
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  icon: Icon(Icons.refresh, size: 18, semanticLabel: 'Refresh'),
                                  label: Text('Retry'),
                        ...
                        : DropdownButtonFormField<int>(
                            ...
                            items: _buildings
                                .map((building) => DropdownMenuItem(value: building.id, child: Text(building.name)))
                                .toList(),
                            onChanged: (value) {
                              if (value != null) {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              IconButton(
                                icon: const Icon(Icons.remove, size: 18, semanticLabel: 'Remove'),
                                color: Colors.white,
  ...
  Widget _buildEquipmentCheckbox(
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          border: Border.all(color: isSelected ? primaryColor : mutedColor.withOpacity(0.3), width: isSelected ? 2 : 1),
          borderRadius: BorderRadius.circular(8),
